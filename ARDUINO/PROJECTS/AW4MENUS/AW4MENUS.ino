...
#define imagedatatype  unsigned short
  ...
  int pwm1_value = 0 ;
  int pwm2_value = 0 ;
  int HOME, PW1_UP, PW1_DOWN, PW1_MAS, PW1_MENOS, PW2_MAS, PW2_MENOS, PW2_UP, PW2_DOWN, PW1_0, PW1_380, PW1_700, PW1_1A, PW2_0, PW2_380, PW2_700, PW2_1A, but4, butX, butY, pressed_button;
  boolean default_colors = true;
